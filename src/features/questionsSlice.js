...
export const sliceQuestion = createSlice({
    ...
    initialState:{
        ...
        [
            ...
            {
                domanda: "Se il verbo è SINGOLARE, qual è il soggetto?",
                opzioneA: "Dominae",
                opzioneB: "Ancillă",
                risposta: "Ancillă",
                showError: false,
...
export const selectShowErrorFive = createSelector(
    selectQuestions, selectSetQuestions,
    (questions, numberSetQuestions) => questions[numberSetQuestions][5].showError
)
